  ...
  <div id='homepage'>
    ...
    <div className='pusher'>
      ...
      <div className='ui stackable two column grid container' id='features'>
        ...
        <div className='column'>
          <img src='/images/feat/search.png' alt='search' />
        </div>
        <div className='column'>
        ...
        <div className='column'>
          <img src='/images/feat/mobile.png' alt='mobile' />
        </div>
        <div className='column'>
        ...
        <div className='column'>
          <img src='/images/feat/bookmarklet.png' alt='bookmarklet' />
        </div>
        <div className='column'>
        ...
        <div className='column'>
          <img src='/images/feat/cli.png' alt='CLI' />
        </div>
        <div className='column'>
        ...
        <div className='column'>
          <img src='/images/feat/nodered.png' alt='NodeRED' />
        </div>
      </div>
